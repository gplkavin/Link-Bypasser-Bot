...
# bot
bot_token = os.environ.get("TOKEN", "5935817397:AAEDzseVGwNBzMTb4-xTckpbjDk-plX3duE")
api_hash = os.environ.get("HASH", "bedabcb3509638b2ff0fedf2492dcb08") 
api_id = os.environ.get("ID", "7206698")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Owner", url="https://telegram.me/GPL_Kavin")]]), reply_to_message_id=message.id)
